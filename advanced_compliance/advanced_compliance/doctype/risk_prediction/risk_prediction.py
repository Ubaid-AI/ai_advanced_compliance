...
class RiskPrediction(Document):
    ...
    @staticmethod
    def create_prediction(control_id, failure_probability, contributing_factors=None,
                          recommended_actions=None, model_version=None, confidence=None,
                          feature_values=None, prediction_time_ms=None):
        """
    ...
    def get_current_prediction(control_id):
        ...
        name = frappe.db.get_value(
            "Risk Prediction",
            {"control": control_id, "is_current": 1},
            "name"
        )
        if name:
    ...
    def get_high_risk_controls(threshold=None):
        ...
        return frappe.get_all(
            ...
            fields=[
                ...
                "failure_probability", "risk_level", "contributing_factors"
            ],
