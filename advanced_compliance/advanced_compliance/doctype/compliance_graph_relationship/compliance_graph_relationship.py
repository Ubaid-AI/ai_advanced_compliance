...
class ComplianceGraphRelationship(Document):
    ...
    @staticmethod
    def create_relationship(relationship_type, source_entity, target_entity,
    ...
    def get_relationships(entity_name, relationship_type=None, direction="both"):
        ...
        if direction == "outgoing":
            ...
            return frappe.get_all(
                ...
                fields=["name", "relationship_type", "source_entity", "target_entity",
                        "weight", "source_entity_type", "target_entity_type"]
            )
