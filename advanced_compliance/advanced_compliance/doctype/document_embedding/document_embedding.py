...
class DocumentEmbedding(Document):
    ...
    @staticmethod
    def create_embedding(source_doctype, source_document, source_field,
                         embedding_vector, source_text, model_name):
        """
    ...
    def get_all_embeddings(source_doctype=None, limit=1000):
        ...
        return frappe.get_all(
            ...
            filters=filters,
            fields=[
                "name", "source_doctype", "source_document",
                "source_field", "embedding_vector", "source_text"
            ],
            limit=limit
        )
