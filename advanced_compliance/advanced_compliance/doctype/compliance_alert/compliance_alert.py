...
class ComplianceAlert(Document):
    ...
    @staticmethod
    def create_alert(alert_type, severity, title, description=None,
                     related_doctype=None, related_document=None,
                     detection_rule=None, detection_details=None):
        """
    ...
    def get_active_alerts(status=None, severity=None, alert_type=None, limit=50):
        ...
        return frappe.get_all(
            ...
            filters=filters,
            fields=[
                "name", "alert_type", "severity", "status", "title",
                "description", "detected_at", "related_doctype", "related_document"
            ],
