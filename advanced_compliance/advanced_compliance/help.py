...
HELP_TOPICS = {
	"Control Activity": {
		...
		"description": _("Controls are the policies and procedures that mitigate risks. They ensure business processes operate as intended and comply with regulations."),
		"fields": {
			"control_name": _("A unique, descriptive name for the control (e.g., 'Journal Entry Approval Over $10,000')"),
			"control_type": _("Preventive controls stop issues before they occur; Detective controls identify issues after they happen"),
			"is_key_control": _("Key controls are critical for financial reporting accuracy and are subject to more rigorous testing"),
	...
	"Risk Register Entry": {
		...
		"description": _("Document and assess organizational risks. The risk register helps prioritize controls and resources."),
		"fields": {
			"risk_title": _("Brief, clear description of the risk"),
			"risk_category": _("Classification for reporting and analysis (Financial, Operational, Compliance, etc.)"),
	...
	"Test Execution": {
		...
		"description": _("Document and track control testing activities. Testing verifies that controls operate as designed."),
		"fields": {
			...
			"test_result": _("Overall result: Effective, Ineffective - Minor/Significant/Material, or Not Applicable"),
	...
	"Regulatory Update": {
		...
		"description": _("Track changes to regulations and standards that may impact your compliance program."),
		"fields": {
	...
	"Knowledge Graph": {
		...
		"description": _("The knowledge graph maps relationships between compliance entities, enabling impact analysis and gap detection."),
		"tips": [
...
def get_help(doctype, field=None):
	...
	if not help_data:
		return {
			"title": doctype,
			"description": _("No help available for this DocType")
		}
	...
	if field and "fields" in help_data:
		...
		return {
			"title": field,
			"description": _("No help available for this field")
		}
		...
		"steps": [
			{
				...
				"description": _("Configure company settings and compliance frameworks in Intercompany Settings."),
				"action": "Intercompany Settings"
			},
			{
				"number": 2,
				"title": _("Define Your Risks"),
				"description": _("Document organizational risks in the Risk Register. Start with your highest-impact areas."),
				"action": "Risk Register Entry"
			},
			{
				"number": 3,
				"title": _("Create Control Activities"),
				"description": _("Document controls that mitigate your identified risks. Link each control to relevant risks."),
				"action": "Control Activity"
			},
			{
				"number": 4,
				"title": _("Execute Control Tests"),
				"description": _("Perform and document control testing. Attach evidence to support your conclusions."),
			...
			},
			{
				...
				"description": _("Configure regulatory feeds to stay current with changes that may affect your controls."),
