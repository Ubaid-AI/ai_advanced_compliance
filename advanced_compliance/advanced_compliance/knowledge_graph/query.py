...
class GraphQueryEngine:
    ...
    def traverse(self, start_entity, relationship_types=None, entity_types=None,
                 direction="outgoing", max_depth=3, include_start=True):
        """
    ...
    def get_entities_by_type(self, entity_type, filters=None, limit=100):
        ...
        entities = frappe.get_all(
            ...
            fields=["name", "entity_type", "entity_doctype", "entity_id",
                    "entity_label", "properties", "node_color", "node_size"],
            limit=limit
        )
    ...
    def get_relationship_count(self, entity_name):
        ...
        outgoing = frappe.db.count(
            "Compliance Graph Relationship",
            {"source_entity": entity_name, "is_active": 1}
        )

        incoming = frappe.db.count(
            "Compliance Graph Relationship",
            {"target_entity": entity_name, "is_active": 1}
        )
    ...
    def get_graph_for_visualization(self, entity_type=None, relationship_types=None,
                                    center_entity=None, max_nodes=100, depth=2):
        """
