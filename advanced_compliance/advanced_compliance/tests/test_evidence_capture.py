...
class TestControlEvidenceDocType(unittest.TestCase):
    ...
    def test_control_evidence_fields_exist(self):
        ...
        required_fields = [
            "control_activity", "source_doctype", "source_name",
            "captured_at", "evidence_hash", "document_snapshot",
            "workflow_log", "version_history", "comments_log"
        ]
...
class TestEvidenceGetForControl(unittest.TestCase):
    ...
    def test_get_evidence_for_control_method(self):
        ...
        from advanced_compliance.advanced_compliance.doctype.control_evidence.control_evidence import ControlEvidence
