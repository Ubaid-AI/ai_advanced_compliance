...
class TestComplianceGraphRelationship(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.control_entity = create_test_entity(
            "Control",
            "Control Activity",
            "REL-TEST-CTRL-001"
        )

        cls.risk_entity = create_test_entity(
            "Risk",
            "Risk Register Entry",
            "REL-TEST-RISK-001"
        )

        cls.person_entity = create_test_entity(
            "Person",
            "User",
            "Administrator"
        )
...
class TestComplianceGraphPath(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.entity1 = create_test_entity(
            "Risk",
            "Risk Register Entry",
            "PATH-TEST-RISK-001"
        )

        cls.entity2 = create_test_entity(
            "Control",
            "Control Activity",
            "PATH-TEST-CTRL-001"
        )
...
class TestGraphQueryEngine(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.entity_person = create_test_entity(
            "Person",
            "User",
            "Administrator",
            "Admin User"
    ...
    def test_06_find_path(self):
        ...
        path = engine.find_path(
            self.entity_person.name,
            self.entity_risk.name,
            max_depth=3
        )
    ...
    def test_10_get_graph_for_visualization(self):
        ...
        data = engine.get_graph_for_visualization(
            center_entity=self.entity_control.name,
            depth=1
        )
...
class TestCoverageAnalyzer(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.risk_covered = create_test_entity(
            "Risk",
            "Risk Register Entry",
            "COV-TEST-RISK-COVERED"
        )

        cls.risk_uncovered = create_test_entity(
            "Risk",
            "Risk Register Entry",
            "COV-TEST-RISK-UNCOVERED"
        )

        cls.control = create_test_entity(
            "Control",
            "Control Activity",
            "COV-TEST-CTRL-001"
        )
