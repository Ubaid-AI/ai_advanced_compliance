...
def after_migrate():
    ...
    try:
        ...
        frappe.log_error(
            message=f"Error creating compliance master data: {str(e)}",
            title="Advanced Compliance Setup"
        )
...
def create_default_categories():
    ...
    # Control Categories
    control_categories = [
        {"category_name": "Financial Reporting", "description": "Controls over financial statement assertions"},
